...
static const string mainnet_seeds[] = {"18.196.233.17", "18.197.49.217", "18.197.63.122", "13.81.80.199", "13.81.97.125", "13.81.99.236", ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("18.196.233.17", 40002), true);
  }
  do {
